...
/* This method return a pointer to an array of Platforms in which are stored all
 * the platforms that are in the current Chunk. To get this pointer you first
 * need to instantiate a Map object, then you can use the method get_chunk(...)
 * to get the desired Chunk,and then you can call the get_platforms() method. */
